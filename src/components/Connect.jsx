...
const Connect = () => {
  return (
    <div name="connect" className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-gray-500'>Connect</p>
                <p className='py-6'>Submit the form below to get in touch with me</p>
            </div>
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/19bb90cb-044c-4fa2-a3ba-005a23bda2b6" method='POST' className='flex flex-col w-full md:w-1/2'>
                    ...
                    <input type="text" name="email" placeholder='Enter your email' className='my-4 p-2 bg-transparent
                     ...
                     my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300'>Let's talk
